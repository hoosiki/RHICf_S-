...
G4VPhysicalVolume* RHICFDetectorConstructionTLwoW::Construct ( )
{
    ...
    RHICFManager::GetInstance()->SetARM1Y(-4.74);//TS CENTER
    ...
    //Junsang****fParser.Read("./geometry/full_tl.gdml");
    G4String geo = FileManager::GetInstance()->GetGeometryPath() + "/full_tl.gdml";
    fParser.Read(geo);
