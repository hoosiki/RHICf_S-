...
G4ThreadLocal MagneticField* RHICFDetectorConstructionTOPwoW::fMagneticField = 0;
G4ThreadLocal G4FieldManager* RHICFDetectorConstructionTOPwoW::fFieldMgr = 0;

RHICFDetectorConstructionTOPwoW::RHICFDetectorConstructionTOPwoW ( ):G4VUserDetectorConstruction(),  fVisAttributes()
{
}

RHICFDetectorConstructionTOPwoW::~RHICFDetectorConstructionTOPwoW ( )
{
}

G4VPhysicalVolume* RHICFDetectorConstructionTOPwoW::Construct ( )
{
    ...
    RHICFManager::GetInstance()->SetARM1Y(2.4+(30.1*sqrt(2)+5)/10.);//TS CENTER
...
void RHICFDetectorConstructionTOPwoW::ConstructSDandField()
{
...
void RHICFDetectorConstructionTOPwoW::SetMagneticField(G4LogicalVolume* logical )
{


}

void RHICFDetectorConstructionTOPwoW::SetDEScorer(G4String string)
{
...
void RHICFDetectorConstructionTOPwoW::SetDENOPScorer(G4String string)
{
...
void RHICFDetectorConstructionTOPwoW::SetSDForFrontCounter()
{
...
void RHICFDetectorConstructionTOPwoW::SetSDForARM1() //FUNCTION FOR SETTING SD OF ARM1
{
    /*-*/// FOR DEPOSIT ENERGY
    for (int i = 0; i < 10; i++) 
    {
...
void RHICFDetectorConstructionTOPwoW::SetSDForSTARZDC() //FUNCTION FOR SETTING SD FOR STARZDC
{
    /*-*/// FOR DEPOSIT ENERGY
    for (int i = 0; i < 3; i++) 
    {
